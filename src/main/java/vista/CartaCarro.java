...
public class CartaCarro extends javax.swing.JFrame {
    ...
    ControladorCartaCarro objControladorCartaCarroPrueba;    
    ...
    public CartaCarro() {
        ...
        objControladorCartaCarroPrueba = new ControladorCartaCarro(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CartaCarro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CartaCarro().setVisible(true);
            }
        });
    }
